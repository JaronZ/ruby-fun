...
public class FoodEffectBase extends FoodBase {
    ...
    public FoodEffectBase(String name, int amount, float saturation, boolean isWolfFood, boolean alwaysEdible, PotionEffect effect){
        super(name, amount, saturation, isWolfFood, alwaysEdible);
        this.effect = effect;
    }
